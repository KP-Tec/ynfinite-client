...
const YnfiniteForms = __webpack_require__(6);
...
const YnfiniteForms = {
  setup() {
    document.addEventListener("DOMContentLoaded", () => {
      const forms = document.querySelectorAll("[data-ynfiniteform=true]");
      forms.forEach(form => {
        const complexFields = form.querySelectorAll(".widget--complexFormField");
        complexFields.forEach(complexField => {
          const newAction = complexField.querySelector(".yn-complexForm-actions-new");
          const rowTemplate = complexField.querySelector("#complexField_" + complexField.dataset.ynformuid);
          const dataContainer = complexField.querySelector(".yn-complexForm-data");
          newAction.addEventListener("click", e => {
            e.preventDefault();
            const newRow = rowTemplate.content.cloneNode(true);
            newRow.className = "yn-complexForm-row";
            const deleteButton = newRow.querySelector(".yn-complexFormActions-delete");
